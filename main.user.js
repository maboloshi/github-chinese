...
(function (window, document, undefined) {
            ...
            'zh-TW': {
                'title': {
                    'static': {
                        ...
                        "Join GitHub · GitHub": "加入 GitHub · GitHub",
                        "Forgot your password? · GitHub": "忘記您的密碼嗎？· GitHub",
                        "Forgot your password?": "忘記您的密碼嗎？",
                        "GitHub · Where software is built": "GitHub - 軟體建構的地方",
                        ...
                        "Your Followers": "您的跟隨者",
                        "Who You’re Following": "您正在跟隨的人",
                        ...
                        "Webhooks": "Web 開關",
                        "Environments": "環境",
                        "Code security & analysis": "代碼安全與分析",
                        "Deploy keys": "部署金鑰",
                        ...
                        "Teams": "團隊",
                        "Trending  repositories on GitHub today": "今日 GitHub 熱門倉庫",
                        "Trending  repositories on GitHub this week": "本周 GitHub 熱門倉庫",
                        "Trending  repositories on GitHub this month": "本月 GitHub 熱門倉庫",
                        ...
                        "Package": "軟體包",
                        "Security": "安全",
                        "Verified & approved domains": "已驗證和批准的域名",
                        "Add a Pages verified domain": "添加一個已驗證的 GitHub Pages 域名",
                        ...
                        "Your stars": "您的星標",
                        "Your starred repositories": "您的星標倉庫",
                        "Your starred topics": "您的星標主題",
                        "Pull Requests": "拉取請求",
                        "Register for the GitHub Developer Program": "註冊 GitHub 開發者計劃",
                        "Codespaces": "代碼空間",
                        "Codespace Templates": "代碼空間模板",
                        "Create new codespace": "建立新代碼空間",
                    },
                    'regexp': [
                        [/GitHub/, 'GitHub 中文'],
                        ...
                        [/People · Pending Collaborators/, "人員 · 待定合夥人"],
                        [/People/, "人員"],
                        [/Outside collaborators/, "外部合夥人"],
                        [/Discussions/, "討論"],
                        [/Workflow runs/, "工作流程運行"],
                        [/Add a code of conduct to/, "添加行為準則到"],
                        ["_regexp_end", "end"]
                    ]
                },
                'page-dashboard':{
                    'static': {
                        // 新手帮助
                        "Learn Git and GitHub without any code!": "了解 Git 和 GitHub 无需任何代碼！",
                        ...
                        "Welcome to your personal dashboard, where you can find an introduction to how GitHub works, tools to help you build software, and help merging your first lines of code.": "歡迎來到您的個人儀表板，在這裡您可以找到關於 GitHub 工作原理的介紹，幫助您構建軟體的工具，以及幫助您合併您的第一行代碼。",
                        ...
                        "Install a powerful code editor": "安裝一個強大的代碼編輯器",
                            "is a multi-platform code editor optimized for building and debugging software.": "是針對構建和調試軟體進行了優化的多平台代碼編輯器。",
                        ...
                        "Get started on GitHub": "開始使用 GitHub",
                            "You're seeing this because you haven't used GitHub's core features, yet.": "您看到這個是因為您還沒有使用過 GitHub 的核心功能。",
                        ...
                        "Loading activity...": "加載活動...",
                        "All activity": "所有活動",

                        "Welcome to the new feed!": "歡迎來到新的動態提要!",
                        "We’re updating the cards and ranking all the time, so check back regularly. At first, you might need to follow some people or star some repositories to get started": "我們一直在更新卡片和排名，所以請定期查看。起初，您可能需要關注一些人或給一些倉庫點星以開始",
                        "Send feedback": "發送反饋",

                        "Updates to your homepage feed": "主頁動態摘要的更新",
                        "We've combined the power of the Following feed with the For you feed so there’s one place to discover content on GitHub. There’s improved filtering so you can customize your feed exactly how you like it, and a shiny new visual design. ✨": "我們將 “關注動態提要” 與 “您的動態提要” 的強大功能結合在一起，讓您在一個地方就能發現 GitHub 上的內容。此外，我們還改進了過濾功能，讓您可以完全按照自己的喜好定制動態提要，並採用全新的視覺設計。 ✨",
                        "Learn more": "了解更多",

                        // 提要過濾
                        "Filter": "過濾器",
                            "Feed filters": "動態提要過濾器",
                            "Events": "事件",
                                "Activity you want to see on your feed": "您想在動態提要上看到的活動",
                            "Announcements": "公告",
                            ...
                            "Stars": "星標",
                                "Repositories being starred by people": "被人們星標的倉庫",
                            "Repositories": "倉庫",
                                "Repositories that are created or forked by people": "由人們創建或複製的倉庫",
                        ...
                        "Uh oh!": "哎呀！",
                        "There was an error in loading the activity feed.": "加載動態提要時發生錯誤。",
                        "Reload this page.": "重新加載此頁面",
                        ...
                        "published a release": "發佈了發佈",
                        "forked a repository": "複製了倉庫",
                        "starred a repository": "給了星標倉庫",
                        "sponsored": "贊助了",
                        "followed": "關注了",
                        ...
                        "has a new discussion in": "有條新討論，在",
                ...
                'pubilc': {
                    'static': {
                        "No server is currently available to service your request.": "目前沒有可用的伺服器來處理您的請求。",
                        "This page is taking too long to load.": "此頁面載入時間過長。",
                        "Sorry about that. Please try refreshing and contact us if the problem persists.": "對此我們深感抱歉。請嘗試重新整理，如果問題仍然存在，請與我們聯繫。",
                        "Contact Support": "聯繫 GitHub 支援",
                        ...
                        "Search in this directory": "在這個目錄中搜尋",
                        "Search in this repository": "在這個倉庫中搜尋",
                        "Search in this owner": "在這個所有者中搜尋",
                        "Search in this organization": "在這個組織中搜尋",
                        "Owners": "所有者",
                        "Languages": "語言",
    ...
    function registerMenuCommand() {
        // 定义一个通用的切换处理器
        const toggleSetting = (settingName, successMessage, failureMessage) => {
            return () => {
                // 切换设置值
                const newValue = (settingName === 'enable_RegExp') ? !enable_RegExp : (lang === 'zh-CN' ? 'zh-TW' : 'zh-CN');
                
                // 更新设置值
                if (settingName === 'enable_RegExp') {
                    enable_RegExp = newValue;
                } else {
                    lang = newValue;
                }
                ...
                // 尝试保存设置
                try {
                    GM_setValue(settingName, newValue);
                    // 显示成功消息
                    GM_notification(successMessage);
                } catch (error) {
                    // 显示失败消息
                ...
                // 如果是启用/禁用正则表达式，则刷新页面
                if (settingName === 'enable_RegExp' && newValue) {
                    location.reload();
                }
                
                // 注销旧的菜单命令
                GM_unregisterMenuCommand(settingName === 'enable_RegExp' ? id1 : id2);
                
                // 注册新的菜单命令
                const newId = GM_registerMenuCommand(successMessage, toggleSetting(settingName, successMessage, failureMessage));
                // 更新对应菜单命令的ID
                if (settingName === 'enable_RegExp') {
                    id1 = newId;
                } else {
        ...
        // 为“开启/关闭正则功能”创建切换命令
        const toggleRegExp = toggleSetting('enable_RegExp', `已${enable_RegExp ? '开启' : '关闭'}正则功能`, '无法更新正则功能状态');
        
        // 为“切换语言”创建切换命令
        const toggleLang = toggleSetting('lang', `已切换为${lang === 'zh-CN' ? '中文-TW' : '中文-CN'}`, '无法更新语言设置');

        // 初始注册
        let id1 = GM_registerMenuCommand(`${enable_RegExp ? '关闭' : '开启'}正则功能`, toggleRegExp);
        let id2 = GM_registerMenuCommand(`切换为${lang === 'zh-CN' ? '中文-TW' : '中文-CN'}`, toggleLang);
    }
