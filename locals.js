    ...
    "static": { // 静态翻译
        ...
        "Feature preview": "功能预览",
            ...
            "Colorblind themes": "色盲主题",
                "Varying by gender and geography, color blindness can affect on average 5-6% of men and up to 0.4% of women. Our previous colorblind theme has been split into two new themes:": "色盲会因性别和地域的不同而有所不同，平均而言，色盲会影响5-6%的男性和高达0.4%的女性。我们之前的色盲主题被分为两个新主题：",
                "Light/dark Protanopia & Deuteranopia for red/green color blindness.": "Protanopia & Deuteranopia：红绿色盲主题",
                "Light/dark Tritanopia for blue/yellow color blindness.": "Tritanopia：蓝黄色盲主题",
            "Command Palette": "命令面板",
                "Quickly navigate and jump between your organizations or repositories and search recent issues, pull requests, projects and more with the new command palette. You can also execute time saving commands all without lifting your fingers off the keyboard!": "使用新的命令面板，可以快速导航并跳转到您所在的组织或存储库，并搜索最近的问题、拉取请求、项目等等。您还可以执行节省时间的命令，而无需将手指从键盘上移开！",
                "To open the command palette:": "打开命令面板：",
            "Global Navigation Update": "全局导航更新",
            "Rich Jupyter Notebook Diffs": "丰富的 Jupyter Notebook 差异",
                "Enables rich diffs of Jupyter Notebooks in pull requests": "支持在拉取请求中启用Jupyter Notebook的丰富差异比较功能",
                "Note: commenting on rich diff views of notebooks is not yet supported.": "注意：不支持在丰富差异视图中评论笔记。",
            "Project Migration": "项目迁移",
                "We've made it easy for you to migrate your project (classic) boards to the all new Projects experience! Enable this feature so that you can try out tables, multiple views, new automation options, and powerful field types using your existing projects.": "我们为您的项目（经典）板迁移到全新的项目体验提供了便利！启用此功能，您可以使用现有的项目尝试表格、多个视图、新的自动化选项和强大的字段类型。",
                "How it works:": "如何工作：",
                    "We'll create a copy of your existing classic project board in Projects.": "我们将在“项目”中创建现有经典项目板的副本。",
                    "You'll be prompted to close your classic project as future changes won't be synchronized.": "系统将提示您关闭经典项目，因为未来的更改将不同步。",
                    "You can reopen your old project in a pinch if necessary!": "如果有必要，你可以在短时间内重新打开旧项目！",
                "Notes:": "注意：",
                    "Migrated projects will be made private by default.": "默认情况下，迁移的项目将设为私有。",
                    "Projects does not support repository level projects. When you migrate a repository project board, it will migrate to either the organization or personal account that owns the repository project, and the migrated project will be pinned to the original repository. We will migrate permissions to the best of our ability but some folks may lose read or writes access.": "项目不支持存储库级别的项目。当您迁移存储库项目板时，它将被迁移到拥有存储库项目的组织或个人帐户，并且迁移的项目将被固定到原始存储库。我们将尽最大努力迁移权限，但有些人可能会失去读取或写入权限。",
...
I18N.zh["page-profile"] = { // 个人首页
    "static": { // 静态翻译
        ...
        // 概述标签卡 即主页 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            // 顶部提醒
            "You unlocked new Achievements with private contributions! ": "您已解锁了私人贡献的新成就！",
            "Show them off by including private contributions in your Profile in": "通过在个人资料中包含私人贡献来展示它们。",
...
I18N.zh["settings/profile"] = { // 设置 - 个人资料
    "static": { // 静态翻译
        ...
        // Profile 个人资料 https://github.com/settings/profile
            ...
            "for guides, our API reference, and other resources for building applications that integrate with GitHub. Make sure your contact information is up-to-date below. Thanks for being a member!": "以获取指南、我们的 API 参考资料以及用于构建与 GitHub 集成的应用程序的其他资源。请确保您的联系信息是最新的。感谢您成为会员！",
            "Support email address": "支持电子邮件地址",
            "An email address where GitHub users can contact you for support.": "GitHub 用户可以联系您寻求支持的电子邮件地址。",
            "Product or company website": "产品或公司网站",
            "The URL for the product, company, or service that integrates with GitHub.": "与 GitHub 集成的产品、公司或服务的URL。",
