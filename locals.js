...
I18N.zh["/organizations/enterprise_plan"] = { // 企业版订阅页面
    "static": {
        "Pick your trial plan":"选择您的试用计划",
        "Recommended":"推荐",
        "Enterprise Cloud":"企业云",
        "Build and deploy to GitHub-hosted cloud environments, directly from your repositories.":"直接从您的仓库构建并部署到GitHub托管的云环境。",
        "Enterprise Server":"企业服务器",
        "Manage and deploy GitHub Enterprise on your own servers, including AWS, Azure, or GC":"在您自己的服务器（包括 AWS、Azure 或 GC）上管理和部署GitHub企业版",
        "Why teams ❤️ it:":"为何团队❤️它：",
        "Get started in minutes, and leave the infrastructure to us.":"立即开始使用，将基础设施交给我们来处理。",
        "Control where your code and data live in a private cloud.":"控制您的代码和数据在私有云中的位置。",
    }
};