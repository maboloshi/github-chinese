            ...
            // 具体内容
                "Code management": "代码管理",
                    "Public repositories": "公共仓库",
                        "Host open source projects in public GitHub repositories, accessible via web or command line. Public repositories are accessible to anyone at GitHub.com.": "把开源项目托管在公共的GitHub仓库中，可以通过网页或命令行访问。公共仓库对任何人都在GitHub.com上都是可访问的。",
                    "Private repositories": "私有仓库",
                        "Host code in private GitHub repositories, accessible via appliance, web, and command line. Private repositories are only accessible to you and people you share them with.": "把代码托管在私有的GitHub仓库中，可以通过设备、网页和命令行访问。私有仓库只有你和你分享的人能够访问。",
                ...
                "Code workflow": "代码工作流",
                    ...
                    "GitHub Packages": "Github 软件包",
                        "Host your own software packages or use them as dependencies in other projects. Both private and public hosting available. Packages are free for public repositories.": "托管您的软件包或将它们用作其他项目的依赖项。提供私有和公共托管。对于公共仓库，软件包是免费的。",
                    "Code reviews": "代码审查",
                        "Review new code, see visual code changes, and confidently merge code changes with automated status checks.": "审查新代码，查看可视化的代码更改，并通过自动化状态检查自信地合并代码更改。",
                    // 拉取请求
                        "Allow contributors to easily notify you of changes they've pushed to a repository – with access limited to the contributors you specify. Easily merge changes you accept.": "允许贡献者轻松通知您他们推送到仓库的更改，访问仅限于您指定的贡献者。轻松合并您接受的更改。",
                    "Protected branches": "受保护的分支",
                        "Enforce restrictions on how code branches are merged, including requiring reviews by selected collaborators, or allowing only specific contributors to work on a particular branch.": "强制执行对代码分支合并的限制，包括要求由选定的协作者进行审查，或仅允许特定的贡献者在特定分支上工作。",
                    // 代码所有者
                        "Automatically request reviews – or require approval – by selected contributors when changes are made to sections of code that they own.": "在对他们拥有的代码部分进行更改时，自动请求审查或要求选定的贡献者批准。",
                    "Draft pull requests": "起草拉取请求",
                        "Easily discuss and collaborate on pull requests before submitting to formal review.": "在正式审查之前轻松讨论和合作于拉取请求。",
                    "Multiple pull request assignees": "多个拉取请求的指派者",
                        "Assign more than one person to a pull request.": "指派多人进行拉取请求。",
                    "Repository insights": "仓库洞察",
                        "See data about activity and contributions within your repositories, including trends. You can use this data to improve collaboration and make development faster and more effective.": "查看有关仓库内活动和贡献的数据，包括趋势。您可以利用这些数据来改善协作，使开发更加迅速和有效。",
                    // 定时提醒
                        "Send scheduled messages to you or your team listing open pull requests.": "定时发送消息给您或您的团队，列出尚未处理的拉取请求。",
                    "Automatic code review assignment": "自动代码审查指派",
                        "Automatically assign code reviews to members of your team based on one of two algorithms.": "根据两种算法之一，自动将代码审查指派给团队成员。",
                    "Environment protection rules": "环境保护规则",
                        "When a workflow job references an environment, the job won't start until all of the environment's protection rules pass.": "当工作流作业引用一个环境时，该作业将在环境的所有保护规则通过之前不会启动。",
                    "Environment deployment branches and secrets": "环境部署分支和机密",
                        "A job cannot access secrets that are defined in an environment unless it is running on the specified branch.": "除非作业正在指定的分支上运行，否则无法访问在环境中定义的机密。",
                
                "Collaboration": "协作",
                    "Collaborators for public repositories": "公共仓库协作者",
                        "Invite any GitHub member, or all GitHub members, to work with you on code in a public repository you control – including making changes and opening issues.": "邀请任何GitHub成员，或所有GitHub成员，在您控制的公共仓库上与您共同处理代码，包括进行更改和提出议题。",
                    "Collaborators for private repositories": "私有仓库协作者",
                        "Invite any GitHub member, or all GitHub members, to work with you on code in a private repository you control – including making changes and opening issues.": "邀请任何GitHub成员，或所有GitHub成员，在您控制的私有仓库上与您共同处理代码，包括进行更改和提出议题。",
                    // 议题
                        "Track bugs, enhancements, and other requests, prioritize work, and communicate with stakeholders as changes are proposed and merged.": "跟踪漏洞、增强功能和其他请求，优先处理工作，并在变更被提出和合并时与利益相关者进行沟通。",
                    // 项目
                        "Visualize and manage issues and pull requests across tables, boards, and roadmaps with custom fields and views that you can arrange to suit your workflow.": "通过自定义字段和视图，在表格、看板和路线图上可视化和管理议题和拉取请求，以适应您的工作流程。",
                    "Milestones": "里程碑",
                        "Track progress on groups of issues or pull requests in a repository, and map groups to overall project goals.": "跟踪仓库中一组议题或拉取请求的进展，并将这些组映射到整体项目目标。",
                    // 团队讨论
                        "Discuss any topic, unattached to a specific project or issue. Control who has access, notify discussion participants with updates, and link from anywhere.": "讨论任何主题，与特定项目或议题无关。控制访问权限，通过更新通知讨论参与者，并从任何地方链接。",
                    "Organization and team management": "组织和团队管理",
                        "Manage access to projects on a team-by-team, or individual user, basis.": "按团队或个别用户基础管理对项目的访问权限。",
                    "Pages and wikis": "页面和维基",
                        "Host documentation and simple websites for your project in a wiki format that contributors can easily edit either on the web or command line.": "在维基格式中托管您项目的文档和简单网站，贡献者可以轻松在网络或命令行上进行编辑。",
                    "Multiple issue assignees": "多个议题指派者",
                        "Assign more than one person to an issue.": "指派多人处理一个议题。",
                    "GitHub organizations give you team-based access control and discussions.": "GitHub 组织为您提供团队级别的访问控制和讨论。",
                        "Learn more about organizations": "了解组织",

                "Security and compliance": "安全性和合规性",
                    "Code scanning": "代码扫描",
                        "Integrate automated security review into your pull requests with CodeQL. Find, prioritize, and fix vulnerabilities in your repositories without disrupting your workflow.": "使用CodeQL将自动化安全审查集成到您的拉取请求中。在不中断工作流程的情况下，发现、优先处理并修复仓库中的漏洞。",
                    "Secret scanning": "机密扫描",
                        "Detect credentials exposed in your git history, comments, or discussions. Prevent further exposures with push protection, which proactively blocks secrets from being pushed into your code.": "检测在您的git历史记录、评论或讨论中暴露的凭证。通过推送保护，阻止秘密被推送到您的代码中，防止进一步的暴露。",
                    "Dependency review": "依赖审查",
                        "Understand the security impact of newly introduced dependencies during pull requests, before they get merged.": "在拉取请求中了解新引入依赖项的安全影响，确保在合并之前进行评估。",
                    "Security overview": "安全概述",
                        "Get a centralized view of your organization's security risks. Know where security features have and haven’t yet been configured.": "获取对组织安全风险的集中视图。了解安全功能的配置情况，知道哪些已经配置，哪些尚未配置。",
                    "Dependabot alerts": "Dependabot 警报",
                        "Get notified when there are new vulnerabilities affecting dependencies in your repositories.": "在有影响您仓库的新漏洞时收到通知。",
                    "Dependabot security updates": "Dependabot 安全更新",
                        "Keep projects secure by automatically opening pull requests that update vulnerable dependencies to secure versions.": "通过自动打开拉取请求更新易受攻击的依赖项至安全版本，保持项目的安全性。",
                    "Dependabot version updates": "Dependabot 版本更新",
                        "Keep projects up-to-date by automatically opening pull requests that update out-of-date dependencies.": "通过自动打开拉取请求更新过时的依赖项，保持项目的最新状态。",
                    "Repository rules": "仓库规则",
                        "Enforce branch and tag protections across repositories. Rule insights allow you to review rule enforcement and understand its impact.": "在仓库之间强制执行分支和标签保护。规则洞察允许您审查规则执行并了解其影响。",
                    "Required reviews": "批准审查",
                        "Ensure that pull requests have a specific number of approving reviews before collaborators can make changes to a protected branch.": "确保拉取请求在协作者可以对受保护分支进行更改之前具有特定数量的批准审查。",
                    // 所需的状态检查
                        "Ensure that all required CI tests are passing before collaborators can make changes to a protected branch.": "确保在协作者可以对受保护分支进行更改之前，所有必需的持续集成测试都通过。",
                    "GitHub Security Advisories": "GitHub 安全公告",
                        "Privately discuss, fix, and publish information about security vulnerabilities found in your repository.": "在私下讨论、修复并发布有关在您的仓库中发现的安全漏洞的信息。",
                    "Role-based access control": "基于角色的访问控制",
                        "Define users' level of access to your code, data and settings.": "定义用户对您的代码、数据和设置的访问级别。",
                    "Required 2FA": "所需 2FA",
                        "Use an extra layer of security with two factor authentication (2FA) when logging into GitHub.": "在登录GitHub时，使用两步验证（2FA）作为额外的安全层。",
                    // 审计日志
                        "Quickly review the actions performed by members of your organization.": "快速审查组织成员执行的操作。",
                    "Enterprises can connect to advanced systems like LDAP and SAML single sign-on (SSO).": "企业可以连接到高级系统，如LDAP和SAML单一登录（SSO）。",
                        "Learn more about GitHub Enterprise": "了解有关GitHub 企业版的更多信息。",

                "Marketplace and integrations": "市场和集成",
                    // Github应用
                        "Install apps that integrate directly with GitHub's API to improve development workflows – or build your own for private use or publication in the GitHub Marketplace.": "安装与GitHub的API直接集成的应用程序，以改善开发工作流程，或为私人使用或在GitHub 市场上发布构建自己的应用程序。",
                    "Status checks": "状态检查",
                        "Define tests that GitHub automatically runs against code being committed to your repository, and get details about failures and what is causing them.": "定义测试，GitHub会自动运行这些测试来检查提交到您的仓库的代码，并获取有关失败及其原因的详细信息。",
                    "Enterprise Server customers create pre-receive hooks to automatically accept or reject a push.": "企业服务器客户创建预接收挂钩，以自动接受或拒绝推送。",
                        "Learn more about pre-receive hooks": "了解有关预接收挂钩的更多信息。",

                "Support and deployment": "支持与部署",
                    "Community Support": "社区支持",
                        "Get help with most of your GitHub questions and issues in our Community Forum.": "在我们的社区论坛中获取有关大多数GitHub问题和议题的帮助。",
                    "Standard Support": "标准支持",
                        "GitHub Support can help you troubleshoot issues you run into while using GitHub. Get support via the web.": "GitHub支持可以帮助您解决在使用GitHub时遇到的问题。通过网络获取支持。",
    ...
    "static": { // 静态翻译
        ...
        // 某个 GitHub 应用 - 权限 https://github.com/settings/apps/<app-name>/permissions
            ...
            "Add a note to users": "为用户添加注释",
                "This note will be displayed on the permissions update approval page.": "该注释将显示在权限更新审批页面上。",
            ...
            "Protect matching branches": "保护匹配的分支",
                "Require a pull request before merging": "要求在合并前提交拉取请求",
                    ...
                    "Require approvals": "要求审批",
                        "When enabled, pull requests targeting a matching branch require a number of approvals and no changes requested before they can be merged.": "启用后，针对匹配分支的拉取请求需要若干次审批，并且在合并之前无需请求更改。",
                    ...
                    "Dismiss stale pull request approvals when new commits are pushed": "当新的提交被推送时，撤销陈旧的拉取请求审批",
                        "New reviewable commits pushed to a matching branch will dismiss pull request review approvals.": "推送到匹配分支的新的可审查提交将撤销之前的拉取请求的审批。",
                    "Require review from Code Owners": "要求代码所有者进行审查",
                        "Require an approved review in pull requests including files with a designated code owner.": "要求在拉取请求中进行审批，包括有指定代码所有者的文件。",
            ...
            "Deployment protection rules": "部署保护规则",
                ...
                "Required reviewers": "所需的审查者",
                    ...
                    "Prevent self-review": "防止自我审查",
                        "Require a different approver than the user who triggered the workflow run.": "要求与触发工作流程运行的用户不同的审批者。",
                "Wait timer": "等待计时器",
