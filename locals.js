...
I18N.zh["repository/packages"] = { // 仓库 - 软件包页面
    ...
    "regexp": [
        ...
        [/(\d+) repository selected…/, "选中 $1 个仓库"],
        [/(\d+) repositories selected…/, "选中 $1 个仓库"],
        [/Change the role of (\d+) repository\?/, "更改 $1 个仓库的角色？"],
        [/Change the role of (\d+) repositories\?/, "更改 $1 个仓库的角色？"],
        [/(\d+) repository/, "$1 个仓库"],
        [/(\d+) repositories/, "$1 个仓库"],
        [/(\d+) members selected…/, "选中 $1 个成员"],
        [/(\d+) member selected…/, "选中 $1 个成员"],
        [/Change the role of (\d+) members\?/, "更改 $1 个成员的角色？"],
        [/Change the role of (\d+) member\?/, "更改 $1 个成员的角色？"],
        [/(\d+) members/, "$1 个成员"],
        [/(\d+) member/, "$1 个成员"],
